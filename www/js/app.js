...
.factory('shoppingCart',['$rootScope', function($rootScope){
  ...
  return {
    addToCart: function( product ){
      ...
      obj.qty = 1;
      obj.total = "";
      obj.item = {"sku": product.url.split('_')[0], "stock": product.stock, "price": product.price, "img": product.images[0], "name": product.name, "url": product.url};
      obj.addons = {"warranty": product.warrranties, "service": product.services};
